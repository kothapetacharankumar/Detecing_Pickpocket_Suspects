  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <table width="519" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
			...
			<tr>
			  ...
			  <td  width="122" align="left" valign="middle" height="81" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style22 style33" style="margin-left:20px;"><strong>View Trips and Transit Records</strong></div></td>
              <td  width="163" align="left" valign="middle" height="81" style="color:#000000;"><div align="left" class="style42 style41 style10" style="margin-left:20px;"><strong>
                  <a href="S_View_User_Travelled_Details.jsp?uname=<%=uname%>">View</a>
              </strong></div></td>
        ...
        <p class="pages"><a href="S_View_Detect_Pickpocket_Suspects.jsp">Back</a></p>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="ServerLogin.jsp">Log Out </a></li>      
          </ul>
        </div>
      </div>
      <div class="clr"></div>
