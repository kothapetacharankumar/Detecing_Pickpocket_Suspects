...
from Large-Scale Public Transit Records</a></h1>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#FF0033">View Passenger Trips and Transit Records... </h2>
          <div class="clr"></div>
					  ...
					  String s1,s2,s3,s4,s5,s6,s7,s77;
						...
						try 
						{
							...
							String es="No";
						   	...
						   	String query="select * from tdetails where  es!='"+es+"' and edt!='"+ed+"'  and uname='"+uname+"' "; 
