        ...
        <div class="article">
          ...
          <table width="650" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
            <tr>
              ...
              <td  width="145" height="45" valign="middle" bgcolor="#FFFF00"><div align="center" class="style17">No.Of Trips Records </div></td>
          ...
          <%@ include file="connect.jsp" %>
            ...
            <%
					  ...
					  String s1,s2=null,s3,s4,s5,s6,s7,s77;
						int i=0,count=0;
						try 
						{
						   	...
						   	String query="select count(*),uname from tdetails group by uname  "; 
          ...
          <p align="right"><span class="style12"><a href="S_Detect_Pickpocket_Suspects.jsp"></a></span></p>
          <table width="476" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="468"><div align="center"><a href="S_View_Detect_Pickpocket_Suspects.jsp" class="style95">Back</a></div></td>
            </tr>
          </table>
