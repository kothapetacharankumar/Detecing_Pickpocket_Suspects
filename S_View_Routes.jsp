...
from Large-Scale Public Transit Records</a></h1>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#FF0033">View Routes</h2>
          <div class="clr"></div>
          ...
          <table width="650" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
            <tr>
              ...
              <td  width="159" height="45" valign="middle" bgcolor="#FFFF00" ><div align="center" class="style17">Router Number</div></td>
              <td  width="145" height="45" valign="middle" bgcolor="#FFFF00"><div align="center" class="style17"><strong>Boarding Station</strong></div></td>
              <td  width="154" valign="middle" bgcolor="#FFFF00" ><div align="center" class="style17"><strong>Exiting Station</strong></div></td>
            </tr>
