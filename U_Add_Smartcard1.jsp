  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		String s3=request.getParameter("cno");
		String s4=request.getParameter("cv");
		
		Statement st=connection.createStatement();
		st.executeUpdate("insert into cdetails(ct,cn,cno,cv,uname) values ('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+uname+"') ");
		}
		catch(Exception ex)
		{
		out.println(ex);
		   ...
		   <h2> Card Details Added Successfully !!! </h2>
		   <p>&nbsp;</p>
