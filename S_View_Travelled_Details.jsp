...
<head>
<title>View_Travelled_Details</title>
...
from Large-Scale Public Transit Records</a></h1>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#FF0033">View All Passenger Travelled Details</h2>
          <div class="clr"></div>
          ...
          <table width="650" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
            <tr>
			  ...
			  <td  width="154" valign="middle" bgcolor="#FFFF00" ><div align="center" class="style17"><strong>Exiting DT</strong></div></td>
            ...
            <%
					  ...
					  String s1,s2,s3,s4,s5,s6,s7;
						...
						try 
						{
						   	...
						   	String query="select * from tdetails order by uname"; 
