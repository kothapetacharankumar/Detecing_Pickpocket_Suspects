...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style1">Online Product Quantization</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
...
<%
    ...
    try{
		...
		if(type.equalsIgnoreCase("server"))
		{
			...
			String sql="SELECT * FROM server where servername='"+sname+"' and password='"+Password+"' ";
			...
			application.setAttribute("server",sname);
